...
#include "decimal_converter.h"

QString DecimalConverter::toHexadecimal(QString& input) {
...
QString DecimalConverter::convert(QString& input) {
    
    if (m_Type == DecimalConverter::Type::HEX) {
